<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCOSOV.aspx.cs" Inherits="AddCOSOV" %>
...
<body>
    ...
    <table  align="left"  width="100%" cellspacing="0" cellpadding="0" border="0">
        <th colspan="2" align="left">Change Order - Schedule of Values</th>
        <tr>
            <td>
                        <table border="1" style="height: 385px; width: 468px">
                            ...
                            <tr> 
                             ...
                             <tr>
                                    <th>Client Change Order Number</th>
                                    <td><asp:textbox id="txtCONumber"  style="text-align:right"  ValidationGroup="insertnew" runat="server"  MaxLength="24" Width="100px"></asp:textbox></td>
                             </tr>
                            ...
                            <tr>   
                             ...
                             <tr>
                                ...
                                <td><asp:textbox  ValidationGroup="insertnew" id="txtComments" runat="server" TextMode="MultiLine" Rows="3"  Columns="40" Width="224px"></asp:textbox></td>
                            </tr>  
