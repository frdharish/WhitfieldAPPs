<%@ Page Language="C#" AutoEventWireup="true" CodeFile="twc_project_contacts.aspx.cs" Inherits="twc_project_contacts" %>
...
<body>
    ...
    <div>
     <DIV style="OVERFLOW-Y:scroll; WIDTH:376px; HEIGHT:183px;" >
        <asp:CheckBoxList ID="ChkProjContacts" runat="server">
        </asp:CheckBoxList>
