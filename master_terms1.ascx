<%@ Control Language="C#" AutoEventWireup="true" CodeFile="master_terms1.ascx.cs" Inherits="master_terms1" %>
            ...
            <table valign="top" width="50%" align="left" cellpadding="0" cellspacing="0" border="0" style="margin-right: 0px">
                    <tr>
	                    <td valign="top" align="left"> 
				            ...
				            FooterStyle-BackColor="#D9D9D9" CellPadding="3" DataKeyField="sub_terms_id">
                ...
                <tr>
                    <td> 
                            <table cellspacing="5" cellpadding="5" width="100%" border="1">
	                            <tr>
		                            <td valign="top">
		                            <span class="header1">Terms </span><span class="header2">Data Entry</span>   
		                    			<table align="center"  style=" height:250px; width: 50%;" cellspacing="0" 
                                            ...
                                            <tr>                                                                    
                                                <td  valign="top" align="left" class="form1" style="color: Maroon">
                                                     Description:<br/>
                                                             <asp:textbox  ID="txtdesc" CssClass="form1" ValidationGroup="vg1" TextMode="MultiLine" wrap="true" 
                                                                Rows="4" Columns="20" MaxLength="20" runat="server" 
                                                                Width="420px"></asp:textbox> <br />
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="vg1" ControlToValidate="txtdesc"   ForeColor="Red" Font-Bold="true" Display="Static" runat="server">*Required.</asp:RequiredFieldValidator>  
                                                </td>
                                            </tr>
                                            <tr>                                                                    
                                                <td  valign="top" align="left" class="form1" style="color: Maroon">
                                                     Is Default:<br/>
                                                            <asp:RadioButtonList ID="ddldefault" ValidationGroup="vg1" runat="server" CssClass="form1" Width="266px">
                                                            </asp:RadioButtonList><br />
                                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="vg1" ControlToValidate="ddldefault"  InitialValue=""  ForeColor="Red" Font-Bold="true" Display="Static" runat="server">*Required.</asp:RequiredFieldValidator>  
                                                </td>
                                            </tr>
                                        </table>
		                            </td>
		        ...
		        <tr>
			               <td align="center">
			                    <asp:button id="btnSave" runat="server" text="Save" 
                                   CssClass="button" ValidationGroup="vg1" onclick="btnSave_Click1"></asp:button>&nbsp;&nbsp;
     						</td>
			    </tr>
		</table>
</td>
