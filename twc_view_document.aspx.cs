...
public partial class twc_view_document : System.Web.UI.Page
{
    ...
    private void ShowTheFile(String EstNum, String twcProjNumber, String seqNum)
    {
        // Define SQL select statement

        string SQL = "SELECT document,doc_mime_type from whitfield_Project_documents WHERE EstNum = " + EstNum.ToString() + " AND TWC_proj_number = " + twcProjNumber.ToString() + " AND seq_num = " + seqNum.ToString();
