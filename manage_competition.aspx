<%@ Page Title="" Language="C#" MasterPageFile="~/whitfieldmain.master" AutoEventWireup="true" CodeFile="manage_competition.aspx.cs" Inherits="manage_competition" %>
					...
					<TD>
						<TABLE cellSpacing="5" cellPadding="5" width="100%" border="0">
							...
							<TR>
								...
								<TD vAlign="top"><SPAN class="header1">ADMINISTRATION:</SPAN> <SPAN class="header2">COMPETITION</SPAN><BR>
									<BR>
									...
									<TABLE cellSpacing="0" cellPadding="0" border="0">
										<TBODY>
											<TR>
												...
												<TD vAlign="middle"><IMG height="1" alt="" Src="assets/img/spacer.gif" width="10"></TD>
												<TD vAlign="middle"><asp:button id="btnnew" runat="server" Text="Create New Competition" 
											...
											<td><asp:datagrid id="grdRpResults" runat="server" CssClass="#60829F" Width="98%" OnItemCreated="ResultGridItemCreated"
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="EDIT">
															...
															<ItemTemplate>
																<%# ShowEditImage(((DataRowView)Container.DataItem)["CompeID"])%>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
...
function ShowEdit(CompeID)
{
    var pageName = "compmain.aspx";
    var parameters = "?IsNew=N&hCompeID=" + CompeID;
