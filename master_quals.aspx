<%@ Page Title="" Language="C#" MasterPageFile="~/whitfieldmain.master" AutoEventWireup="true" CodeFile="master_quals.aspx.cs" Inherits="master_quals" %>
<%@ Register TagPrefix="uc1" TagName="DynamicTable" Src="master_quals1.ascx" %>
<%@ Import Namespace="System.Data" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<asp:ScriptManager ID="ScriptManager" runat="server" />
  <span class="header1">Qualifications </span><span class="header2">- Adminstration</span> 
  <asp:UpdatePanel ID="UpdatePanelouter" runat="server">    
		...
		<asp:datagrid id="grdEstimateMaterials" runat="server" CssClass="data" Width="50%" 
				...
				FooterStyle-BackColor="#D9D9D9" CellPadding="3" DataKeyField="qual_id">
                ...
                <Columns>
						...
						HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="False">
						<HeaderStyle HorizontalAlign="center" BackColor="#60829F" CssClass="subnav"></HeaderStyle>
						<ItemStyle  BackColor="#EAEFF3"  Wrap="true" Width="450px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
						<ItemTemplate>
            ...
            onclick="popupfunction('add_new_master_quals.aspx');" type="button">Add New Qualification</button>            
        </contenttemplate>        
      </asp:UpdatePanel>
    ...
    function popupfunction(url) {
        ...
        url = pageName;
        agreewin = dhtmlmodal.open("agreebox", "iframe", url, "Qualification Maintenance", "width=600px,height=500px,center=1,resize=1,scrolling=0", "recal")
