<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_new_master_quals.aspx.cs" Inherits="add_new_master_quals" %>
...
<body>
    ...
    <div>
            <table align='center' cellspacing="0" cellpadding="0" bgcolor="#ffffff" border="1" width="50%">
		                                    <tr>
			                                    <td valign="top">
			                                    <span class="header1">Master Qualification </span><span class="header2">Data Entry</span>   
