<%@ Page Title="Manage Clients" Language="C#" MasterPageFile="~/whitfieldmain.master" AutoEventWireup="true" CodeFile="manageclients.aspx.cs" Inherits="manageclients" %>
					...
					<TD>
						<TABLE cellSpacing="5" cellPadding="5" width="100%" border="0">
							...
							<TR>
								...
								<TD vAlign="top"><SPAN class="header1">ADMINISTRATION:</SPAN> <SPAN class="header2">CLIENTS</SPAN><BR>
									<BR>
									...
									<TABLE cellSpacing="0" cellPadding="0" border="0">
										<TBODY>
											<TR>
												...
												<TD vAlign="middle"><IMG height="1" alt="" Src="assets/img/spacer.gif" width="10"></TD>
												<TD vAlign="middle"><asp:button id="btnnew" runat="server" Text="Create New Client" 
									...
									<TABLE cellSpacing="1" cellPadding="1" border="0" width="100%">
										...
										<tr>
											<td><asp:datagrid id="grdRpResults" runat="server" CssClass="#60829F" Width="98%" OnItemCreated="ResultGridItemCreated"
													...
													CellPadding="3" PageSize=100 DataKeyField="ClientID">
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="EDIT">
															...
															<ItemTemplate>
																<%# ShowEditImage(((DataRowView)Container.DataItem)["ClientID"])%>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
...
{
    var pageName = "addclient.aspx";
    var parameters = "?IsNew=N&hClientID="+ clientid;
