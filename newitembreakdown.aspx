<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newitembreakdown.aspx.cs" Inherits="newitembreakdown" %>
    ...
    <table align='center' cellspacing="0" cellpadding="0" bgcolor="#ffffff" border="1" width="50%">
		      <tr>
		                            <asp:HiddenField ID="hidEstNum" runat="server" />
			                            ...
			                            <span class="header1">Item Breakdown List</span><span class="header2"> Data Entry</span>   
			                    			<table align="center"  style=" height:300px; width: 69%;" cellspacing="0" 
                                                ...
                                                <tr>                                                                    
				                                 ...
				                                 <tr>                                                                    
                                                    <td  valign="top" align="left" class="form1" style="color: Maroon">
                                                         Amount:<br/>
                                                                  <asp:textbox id="txtamt"  style="text-align:right"  runat="server" MaxLength="14" Width="75px" onBlur="this.value=formatCurrency(this.value);"></asp:textbox>
                                                    </td>  
                                                </tr>                                                                                               
                                    </table>
                                    </td>
