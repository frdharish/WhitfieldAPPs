<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pick_materials.aspx.cs" Inherits="pick_materials" %>
...
<body>
    ...
    <div>
    <div style="OVERFLOW-Y:scroll; WIDTH:400px; HEIGHT:192px;" >

     <asp:CheckBoxList ID="RdoprjMaterials" runat="server" RepeatDirection=vertical>
        </asp:CheckBoxList>
