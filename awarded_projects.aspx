<%@ Page Language="C#" AutoEventWireup="true" CodeFile="awarded_projects.aspx.cs" Inherits="awarded_projects" %>
...
<body>
    ...
    <DIV style="OVERFLOW-Y:scroll; WIDTH:424px; HEIGHT:192px;" >
            <asp:RadioButtonList ID="RdoAwdProjects" runat="server" RepeatDirection=vertical></asp:RadioButtonList>
