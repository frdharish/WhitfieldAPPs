...
public class whitfield_prod_reports
{
    ...
    public DataSet GetProductionDailyReports()
    {
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            String sqlCommand = " SELECT a.rpt_date,a.twc_report_number,sum(b.fab_hours) as fab_hours,sum(b.fin_hours) as fin_hours ,sum(b.eng_hours) as eng_hours,sum(b.misc_hours) as misc_hours ,sum(b.fab_hours) + sum(b.fin_hours) + sum(b.eng_hours) + sum(b.misc_hours) as TotHours FROM  " +
    ...
    public Boolean UpdateReportActivity(
                                Int32 ActivityId
                                , Int32 fab_hours, Int32 fin_hours, Int32 eng_hours, Int32 misc_hours
     ...
     public DataSet GetProjectReportOuter(String RptDate)
    {
     ...
     {
         Database db = DatabaseFactory.CreateDatabase();
         String sqlCommand = " select a.fab_hours as fab_hours, a.fin_hours as fin_hours, a.eng_hours as eng_hours, a.misc_hours as misc_hours,a.fab_hours + a.fin_hours + a.eng_hours + a.misc_hours as TotHours FROM Whitfield_Project_workorder a" +
     ...
     {
            Database db = DatabaseFactory.CreateDatabase();
            String sqlCommand = " select sum(a.fab_hours) as fab_hours, sum(a.fin_hours) as fin_hours, sum(a.eng_hours) as eng_hours, sum(a.misc_hours) as misc_hours,sum(a.fab_hours) + sum(a.fin_hours) + sum(a.eng_hours) + sum(a.misc_hours) as TotHours FROM twc_daily_prod_activity a, whitfield_project_workorder b WHERE  a.work_order_id = b.work_order_id and a.Project_number = b.EstNum " +
     ...
     {
         Database db = DatabaseFactory.CreateDatabase();
         String sqlCommand = " select sum(a.fab_hours) as fab_hours, sum(a.fin_hours) as fin_hours, sum(a.eng_hours) as eng_hours, sum(a.misc_hours) as misc_hours,sum(a.fab_hours) + sum(a.fin_hours) + sum(a.eng_hours) + sum(a.misc_hours) as TotHours FROM Whitfield_Project_workorder a" +
     ...
     public DataSet GetEmployeeDailyHours(String RptDate)
     {
         ...
         {
             Database db = DatabaseFactory.CreateDatabase();
             String sqlCommand = " SELECT d.FirstName + ' ' + d.LastName as UName , sum(a.fab_hours) as fab_hours, sum(a.fin_hours) as fin_hours, sum(a.eng_hours) as eng_hours, sum(a.misc_hours) as misc_hours,sum(a.fab_hours) + sum(a.fin_hours) + sum(a.eng_hours) + sum(a.misc_hours) as TotHours " +
                                 "    FROM " +
     ...
     public DataSet GetProjectReportInner(Int32 twc_report_number,Int32 twc_proj_Number)
     {
         ...
         {
             Database db = DatabaseFactory.CreateDatabase();
             String sqlCommand = "SELECT a.*,b.Description + '(' + b.work_order_id  + ')' as Description,c.ProjName,d.FirstName + ' ' + d.LastName as UName " +
                                 "   FROM " +
