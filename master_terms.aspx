<%@ Page Title="" Language="C#" MasterPageFile="~/whitfieldmain.master" AutoEventWireup="true" CodeFile="master_terms.aspx.cs" Inherits="master_terms" %>
<%@ Register TagPrefix="uc1" TagName="DynamicTable" Src="master_terms1.ascx" %>
<%@ Import Namespace="System.Data" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<asp:ScriptManager ID="ScriptManager" runat="server" />
  <span class="header1">Terms </span><span class="header2">- Adminstration</span> 
  <asp:UpdatePanel ID="UpdatePanelouter" runat="server">    
		...
		<asp:datagrid id="grdEstimateMaterials" runat="server" CssClass="data" Width="50%" 
				...
				FooterStyle-BackColor="#D9D9D9" CellPadding="3" DataKeyField="terms_id">
                ...
                <Columns>
                        <asp:TemplateColumn HeaderImageUrl="assets/img/Search.gif">
					        ...
					        <ItemStyle Width="10px" VerticalAlign="Top" HorizontalAlign="Center"></ItemStyle>
					        <ItemTemplate>
						...
						<ItemStyle HorizontalAlign="center"  Width="10px" BackColor="#EAEFF3"></ItemStyle>
                        <ItemTemplate>
						...
						<ItemTemplate>
						    <asp:TextBox id="lblgrp"  runat="server" BorderStyle=None BorderWidth=0 BackColor="#EAEFF3" Width="150px"
							         Text='<%# DataBinder.Eval(Container, "DataItem.Group_name") %>'>
							        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							</asp:TextBox>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id="txtgrp"   runat="server" Width="150px" Height="50px"  
							        Text='<%# DataBinder.Eval(Container, "DataItem.Group_name") %>'>
							        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							</asp:TextBox>
						</EditItemTemplate>
						...
						HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="False">
						<HeaderStyle HorizontalAlign="center" BackColor="#60829F" CssClass="subnav"></HeaderStyle>
						<ItemStyle  BackColor="#EAEFF3"  Wrap="true" Width="450px" HorizontalAlign="Left"></ItemStyle>
						<ItemTemplate>
				      ...
				      <asp:TemplateColumn ItemStyle-BackColor="#D9D9D9" HeaderStyle-BackColor="#D9D9D9" >
					            <ItemStyle HorizontalAlign="Center"   ForeColor="#EAEFF3" CssClass="subnav"></ItemStyle>
					            <ItemTemplate>
            ...
            onclick="popupfunction('add_new_master_terms.aspx');" type="button">Add New Terms</button>                   
        </contenttemplate>        
      </asp:UpdatePanel>
    ...
    function popupfunction(url) {
        ...
        url = pageName;
        agreewin = dhtmlmodal.open("agreebox", "iframe", url, "Terms Maintenance", "width=600px,height=500px,center=1,resize=1,scrolling=0", "recal")
