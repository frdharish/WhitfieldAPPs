<%@ Control Language="C#" AutoEventWireup="true" CodeFile="whitfieldnavpuser.ascx.cs" Inherits="whitfieldnavpuser" %>
<!-- ACTUAL NAV CODE -->
				...
				<DIV CLASS="collapsed">
					...
					<DIV CLASS="dropContainer">
						<DIV CLASS="dropMenu">
							...
							<DIV CLASS="dropItem"><A HREF="master_finishes.aspx" NAME="Finishes">Master Finishes Listing</A></DIV>
					...
					<DIV CLASS="navItem" onclick="goTo('#');">Finance</DIV>
							<DIV CLASS="dropContainer">
								<DIV CLASS="dropMenu">
									...
									<DIV CLASS="dropItem"><A HREF="#" NAME="invoice">Project Invoicing</A></DIV>
